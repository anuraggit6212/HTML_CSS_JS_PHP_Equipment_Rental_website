								...
								while ($row=mysqli_fetch_array($query)) {
									?>
										<div class="row">
											...
											<div class="col-md-6">
												<table>
													<tr><td>Equipment Name</td><td><b><?php echo $row["product_title"]; ?></b> </td></tr>
													<tr><td>Equipment Cost</td><td><b><?php echo "Rs ".$row["product_price"]; ?></b></td></tr>
													<tr><td>Hiring Time(in Hrs)</td><td><b><?php echo $row["qty"]; ?></b></td></tr>
