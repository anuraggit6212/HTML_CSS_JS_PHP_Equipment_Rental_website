				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-body'>
									<img src='product_images/$pro_image' style='width:160px; height:250px;' title='$pro_desc'/>
								</div>
								<div class='panel-heading'>Rs. $pro_price.00
									<button pid='$pro_id' style='float:right;' id='product' title='For Taking On Rent' class='btn btn-danger btn-xs'>Add To Cart</button>
								</div>
							</div>
						</div>	
			";
	...
	if (isset($_POST["checkOutDetails"])) {
		if (mysqli_num_rows($query) > 0) {
			...
			echo "<form method='post' action='login_form.php'>";
				...
				if (!isset($_SESSION["uid"])) {
					echo '<input type="submit" style="float:right;" name="login_user_with_product" class="btn btn-info btn-lg" title="Login First To Take On Rent" value="Login First" >
							</form>';
					
				}else if(isset($_SESSION["uid"])){
					echo '<a style="float:right;" name="submit_ch" class="btn btn-info btn-lg" title="Pay/Checkout"  href="cart_process.php">Take On Rent</a>
							</form>'
							;
